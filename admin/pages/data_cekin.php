<?php 
$data = mysqli_query($conn, "SELECT * FROM tb_pemesanan WHERE status = 'Cek In'");
$_SESSION['set_page'] = "data_cekin";
$_SESSION['title'] = "Admin : Hotel Paradiso Makassar";
?>
<div class="row">
	<div class="col-sm-12">
		<div class="card-box table-responsive">
			<h4 class="m-t-0 header-title"><b>Data Cek In</b></h4>
			<hr>
			<table id="datatable" class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td><?= count(explode(',', $dta['no_kamar'])) ?> Kamar</td>
